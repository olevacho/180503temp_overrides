...
if(!VmConfig::get('use_as_catalog', 0)){
	if($product->addToCartButton){
		...
		//$addtoCartButton = shopFunctionsF::getAddToCartButton ($product->orderable);
                $addtoCartButton = shopFunctionsF::renderVmSubLayout('addtocartbtn_signal',array('orderable'=>$product->orderable));
	...
	<div class="addtocart-area">
		<form method="post" class="product js-recalculate" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart',false); ?>">
			<div class="vm-customfields-wrap">
				...
				<?php
				if (!VmConfig::get('use_as_catalog', 0)  ) {
					echo shopFunctionsF::renderVmSubLayout('addtocartbar_signal',array('product'=>$product));
				} ?>
